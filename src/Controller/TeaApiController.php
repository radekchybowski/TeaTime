...
/**
 * Class TeaApiController.
 */
#[Route('/api/teas')]
class TeaApiController extends AbstractFOSRestController
{
    /**
     * Tea service.
     */
    ...
    {
        $teas = $this->teaService->getAll();

        return $this->response($teas);
    }
    ...
    private function response($data, int $status = 200, array $headers = [])
    {
